<?php
    ...
    "poster"=>"{$path}Poster.png","banner"=>"{$path}banner0001.png", "capa"=>"{$path}Poster.png", "jogo"=>"http://localhost/teste/jogos/jogoSubmarineAdventure");
    ...
    "poster"=>"{$path}Galactic Attack.jpeg","banner"=>"{$path}bannerGalacticAttack.jpeg", "capa"=>"{$path}Galactic Attack.jpeg", "jogo"=>"http://localhost/teste/jogos/jogoGalacticAttack");
    ...
    <p>FICHA TÉCNICA</p> <p>Engine: Construct 3</p> <p>Plataforma: PC </p> <p>Mecânica: Plataforma</p> <p>Dispositivos de Entrada: Teclado</p>",
    "poster"=>"{$path}Birdy.jpeg","banner"=>"{$path}bannerBirdy.jpeg", "capa"=>"{$path}Birdy.jpeg","jogo"=>"http://localhost/teste/jogos/jogoBirdy");
    ...
    "poster"=>"{$path}Wildwest.jpeg","banner"=>"{$path}bannerWildwest.jpeg", "capa"=>"{$path}Wildwest.jpeg","jogo"=>"http://localhost/teste/jogos/jogoWildWest");
    ...
    "poster"=>"{$path}Souls Dark.jpeg","banner"=>"{$path}banneSoulsDark.jpeg", "capa"=>"{$path}Souls Dark.jpeg","jogo" => "http://localhost/teste/jogos/jogoSoulsintheDark");
